...
export class Player {
    ...
    renderSprite(ctx, cx, cy) {
        ...
        ctx.drawImage(sprite, sx, sy, FRAME_W, FRAME_H, cx - FRAME_W, cy - FRAME_H, FRAME_W * 2, FRAME_H * 2 // ×2 pour lisibilité pixel art
        );
    }
    /** Rendu de secours : bonhomme simple en canvas 2D */
    renderFallback(ctx, cx, cy) {
